...
jQuery(function() {		
	 ...
	 JQTWEET = {
	    ...
	    user: 'webbudesign', //username
	            numTweets: 5, // Number of tweets
        	    appendTo: '#jstwitter',
	    useGridalicious: false,
	    template: '<div class="tweet"><i class="icon-twitter" style="font-size:14px;"></i> {TEXT}<div class="time">{AGO}</div><div class="dividertwitter"></div>',
	    ...
	    loadTweets: function() {
	        ...
	        jQuery.ajax({
	            url: 'http://metromobile.webbudesign.com/js/grabtweets.php',
	            type: 'POST',
	            dataType: 'json',
	            data: request,
